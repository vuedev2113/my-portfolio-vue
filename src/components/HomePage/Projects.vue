<template>
  <div id="projects" class="relative w-full z-50  my-12 lg:my-24">
    ...
    <div class="pt-24">
      <div class="flex items-center flex-col gap-6">
        <div v-for="project in projectsData" :key="project.id" class="sticky-card w-full mx-auto max-w-2xl sticky top-40">
